                    ...
                    <div className="bg-clip-padding backdrop-filter backdrop-blur-xl bg-opacity-75 card w-96 bg-base-100 shadow-xl m-auto">
                        <form>
                            <div className="card-body px-12 py-14 justify-self-center">
                                ...
                                <input type="text" placeholder="Email" className="input input-bordered my-0.5 w-full max-w-xs" required />
                                <input type="password" placeholder="Password" className="input input-bordered my-0.5 w-full max-w-xs" required />
